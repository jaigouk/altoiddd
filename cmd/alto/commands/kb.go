...
// NewKBCmd creates the "alto kb" command with subcommands.
...
// newKBLookupCmd creates the "alto kb lookup <topic>" subcommand.
...
// newKBDriftCmd creates the "alto kb drift [tool]" subcommand.
