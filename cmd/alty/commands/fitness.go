...
// NewFitnessCmd creates the "alty fitness" command group.
...
Reads .alty/bounded_context_map.yaml and generates arch-go.yml for
architecture fitness testing.

Examples:
  alty fitness generate              # Generate with user confirmation
  alty fitness generate --preview    # Show what would be generated
  alty fitness generate --brownfield # Use 80% compliance threshold`,
