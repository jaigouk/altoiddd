...
bounded_contexts:
  - name: Orders
    ...
    layers:
      ...
      - infrastructure
`
	require.NoError(t, os.WriteFile(filepath.Join(altyDir, "bounded_context_map.yaml"), []byte(bcMapContent), 0o644))
...
bounded_contexts:
  ...
  - name: Shipping
    ...
    layers:
      ...
      - infrastructure
`
	bcMapPath := filepath.Join(altyDir, "bounded_context_map.yaml")
